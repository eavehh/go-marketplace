...
const file_greet_proto_rawDesc = "" +
	...
	"\rHello_request\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"\x1f\n" +
	"\vHello_reply\x12\x10\n" +
	"\x03msg\x18\x01 \x01(\tR\x03msg2@\n" +
	"\aGreeter\x125\n" +
	"\tSay_hello\x12\x14.greet.Hello_request\x1a\x12.greet.Hello_replyBAZ?github.com/eavehh/marketpl.microserv/internal/promotion/grpc/pbb\x06proto3"
...
var file_greet_proto_goTypes = []any{
	(*HelloRequest)(nil), // 0: greet.Hello_request
	(*HelloReply)(nil),   // 1: greet.Hello_reply
}
var file_greet_proto_depIdxs = []int32{
	0, // 0: greet.Greeter.Say_hello:input_type -> greet.Hello_request
	1, // 1: greet.Greeter.Say_hello:output_type -> greet.Hello_reply
