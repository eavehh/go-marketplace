...
const file_promo_proto_rawDesc = "" +
	...
	"\x05value\x18\x04 \x01(\tR\x05value2\xcc\x01\n" +
	...
	"\vCreatePromo\x12\x1d.promotion.CreatePromoRequest\x1a\x1e.promotion.CreatePromoResponseBAZ?github.com/eavehh/marketpl.microserv/internal/promotion/grpc/pbb\x06proto3"
...
var file_promo_proto_goTypes = []any{
	...
	(*Promotion)(nil),                     // 4: promotion.Promotion
}
var file_promo_proto_depIdxs = []int32{
	4, // 0: promotion.GetPromoByCatalogItemResponse.promotion:type_name -> promotion.Promotion
	...
	3, // 4: promotion.PromotionService.CreatePromo:output_type -> promotion.CreatePromoResponse
